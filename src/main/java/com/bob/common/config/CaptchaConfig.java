...
public class CaptchaConfig {
    ...
    public DefaultKaptcha getKaptchaBean(){
        ...
        // 验证码文本样式，默认为new Font("Arial", 1, fontSize), new Font("Courier", 1, fontSize)
    ...
    public DefaultKaptcha getKaptchaBeanMath() {
        ...
        // 验证码文本生成器
        properties.setProperty(KAPTCHA_TEXTPRODUCER_IMPL, "com.bob.common.config.KaptchaTextCreator");
        // 验证码文本字符间距，默认为2
