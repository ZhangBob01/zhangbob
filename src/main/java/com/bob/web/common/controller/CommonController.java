package com.bob.web.common.controller;

import com.bob.common.config.BobConfig;
import com.bob.common.config.ServerConfig;
...
public class CommonController {
    ...
    public void fileDownload(String fileName, Boolean delete, HttpServletResponse response, HttpServletRequest request) {
        try {
            ...
            String filePath = BobConfig.getDownloadPath() + fileName;
    ...
    public void resourceDownload(String resource, HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            // 本地资源路径
            String localPath = BobConfig.getProfile();
            // 数据库资源地址
