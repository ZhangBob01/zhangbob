...
import com.bob.web.system.mapper.SystemRoleDeptMapper;
import com.bob.web.system.mapper.SystemRoleMapper;
import com.bob.web.system.mapper.SystemRoleMenuMapper;
import com.bob.web.system.mapper.SystemUserRoleMapper;
...
public class SystemRoleServiceImpl implements SystemRoleService {
    ...
    public List<SystemRole> selectRolesByUserId(Long userId) {
        List<SystemRole> userRoles = roleMapper.findRoleListByUserId(userId);
...
//        return SpringUtils.getAopProxy(this).selectRoleList(new SystemRole());
        return selectRoleList(new SystemRole());
    }
     ...
     * @param role 角色对象
     */
    public int insertRoleDept(SystemRole role) {
        int rows = 1;
        // 新增角色与部门（数据权限）管理
        List<SystemRoleDept> list = new ArrayList<SystemRoleDept>();
        for (Long deptId : role.getDeptIds()) {
            SystemRoleDept rd = new SystemRoleDept();
