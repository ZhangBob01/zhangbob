...
import com.bob.web.system.mapper.SystemDeptMapper;
...
public class SystemDeptServiceImpl implements SystemDeptService {
     ...
     */
    @Override
    public List<SystemDept> selectDeptList(SystemDept dept) {
     ...
     */
    @Override
    public List<Ztree> selectDeptTree(SystemDept dept) {
        List<SystemDept> deptList = deptMapper.selectDeptList(dept);
     ...
     * @return 树结构列表
     */
    public List<Ztree> initZtree(List<SystemDept> deptList) {
     ...
     */
    @Override
    public List<Ztree> selectDeptTreeExcludeChild(SystemDept dept) {
        Long deptId = dept.getDeptId();
        List<SystemDept> deptList = deptMapper.selectDeptList(dept);
        Iterator<SystemDept> it = deptList.iterator();
        while (it.hasNext()) {
            SystemDept d = (SystemDept) it.next();
     ...
     */
    @Override
    public List<Ztree> roleDeptTreeData(SystemRole role) {
     ...
     */
    @Override
    public int insertDept(SystemDept dept) {
        SystemDept info = deptMapper.selectDeptById(dept.getParentId());
     ...
     * @param dept 当前部门
     */
    private void updateParentDeptStatus(SystemDept dept) {
    ...
    public void updateDeptChildren(Long deptId, String newAncestors, String oldAncestors) {
        List<SystemDept> children = deptMapper.selectChildrenDeptById(deptId);
        for (SystemDept child : children) {
