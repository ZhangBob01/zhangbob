...
public interface SystemDeptMapper {
     ...
     * @return 结果
     */
    int selectDeptCount(SystemDept dept);
     ...
     * @return 结果
     */
    int updateDeptChildren(@Param("depts") List<SystemDept> depts);
     ...
     * @return 结果
     */
    SystemDept checkDeptNameUnique(@Param("deptName") String deptName, @Param("parentId") Long parentId);
     ...
     * @param dept 部门
     */
    void updateDeptStatus(SystemDept dept);
     ...
     * @return 部门列表
     */
    List<SystemDept> selectChildrenDeptById(Long deptId);
