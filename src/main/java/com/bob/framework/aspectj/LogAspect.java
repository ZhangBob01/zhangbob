...
import com.bob.common.enums.BusinessStatus;
import com.bob.common.json.JSON;
...
public class LogAspect {
    ...
    // 配置织入点
    @Pointcut("@annotation(com.bob.common.annotation.Log)")
    ...
    protected void handleLog(final JoinPoint joinPoint, final Exception e, Object jsonResult) {
        try {
            ...
            // 获取当前的用户
            SystemUser currentUser = ShiroUtils.getSysUser();
     ...
     * @throws Exception
     */
    public void getControllerMethodDescription(Log log, SystemOperLog operLog) throws Exception {
        // 设置action动作
     ...
     * @throws Exception 异常
     */
    private void setRequestValue(SystemOperLog operLog) throws Exception {
